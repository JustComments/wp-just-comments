...
<div class="wrap">
    <h2><?php _e( 'Just comments settings page', 'just-comments' ) ?></h2>
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row" valign="top">
					<?php _e( 'Custom HTML', 'just-comments' ) ?>
                    <p>
                        <small><?php _e( 'Original comments will be replaced by this code', 'just-comments' ) ?></small>
                    </p>
                </th>
                <td>
                    <label>
